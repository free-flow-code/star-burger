...
Определите переменную `YANDEX_API_KEY` в том же файле. Получите Yandex geocoder API key
в [кабинете разработчика](https://developer.tech.yandex.ru/).
```shell
YANDEX_API_KEY=a47e5fm4-9poc-6ufc-5463-87axxxf8e480
```
...
- `DB_URL`=url для доступа к базе данных PostgreSQL. Должен иметь вид "postgres://USER:PASSWORD@HOST:PORT/NAME". Например postgres://postgres:qwerty@localhost:5432/mydb
